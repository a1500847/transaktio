...
public class Lainaus {
	...
	private ArrayList<NideLainaus> lista;
	...
	public void addNiteenLainaus(NideLainaus nl)
	{
		if (nl != null)
		{
			if (lista == null)
				lista = new ArrayList<NideLainaus>();
			
			lista.add(nl);
		}
	}
	public NideLainaus getNiteenLainaus(int i)
	{
		NideLainaus paluu = null;
		if (lista != null && i <lista.size())
			paluu = lista.get(i);
		
		return paluu;
	}
	public ArrayList<NideLainaus> getLista() {
		return lista;
	}
