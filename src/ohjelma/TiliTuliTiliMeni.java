...
/**
 * Servlet implementation class TiliTuliTiliMeni
 */
@WebServlet("/TiliTuliTiliMeni")
public class TiliTuliTiliMeni extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public TiliTuliTiliMeni() {
		super();
	...
	protected void doGet(HttpServletRequest request,
		...
		} else if (action.equalsIgnoreCase("hae tietyn tilin tiedot")) {
			request.setAttribute("tili", null);
